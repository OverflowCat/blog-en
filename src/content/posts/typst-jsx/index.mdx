...
And a fake `Compiler` to force unified to think that it has converted the `estree` object to a string:
...
You can see a demo of this in action [here](https://typst.overflow.cat).
Although this feature has been merged into the `master` branch, a full hᴀsᴛ-based approach might have performance implications and hasn't been thoroughly tested yet.
